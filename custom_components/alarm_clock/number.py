...
class AlarmNumber(MorningAlarmEntity, NumberEntity):
    def __init__(self, coordinator, key, name, minimum, maximum, step, unit=None, mode=NumberMode.BOX):
        super().__init__(coordinator,key,name); self._attr_mode=mode; self._attr_native_min_value=minimum; self._attr_native_max_value=maximum; self._attr_native_step=step; self._attr_native_unit_of_measurement=unit
    @property
