...
class AlarmClockBase extends HTMLElement {
  ...
  styles() { return `<style>:host{display:block}ha-card{padding:16px}h2{display:flex;align-items:center;gap:8px;margin:0}.heading{display:flex;flex-direction:column;gap:2px}.heading .sub{font-weight:normal}h2 ha-icon{--mdc-icon-size:28px}h2 ha-icon.enabled{color:var(--primary-color)!important}h2 ha-icon.disabled{color:var(--disabled-text-color,#9e9e9e)!important}.summary{padding:12px}.summary h2{font-size:16px;line-height:1.2}.summary h2 ha-icon{--mdc-icon-size:24px}.summary .sub{font-size:12px}.sub,label{color:var(--secondary-text-color);font-size:13px}.card-header{font-size:20px;font-weight:500;padding-bottom:8px}.row,.media-selector{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:9px 0}.media-selector ha-selector{flex:1;max-width:70%}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(125px,1fr));gap:8px;margin:12px 0}.box{background:var(--secondary-background-color);border-radius:8px;padding:9px}.schedule-list{margin:6px 0}.schedule-list .row{padding:4px 0;border-top:1px solid var(--divider-color);font-size:13px}.schedule-list b{font-variant-numeric:tabular-nums}.time-header{display:flex;align-items:center;justify-content:space-between;gap:8px}input,select,button{font:inherit;padding:6px;border-radius:6px;background:var(--secondary-background-color);color:var(--primary-text-color);border:1px solid var(--divider-color)}.time-controls{display:grid;grid-template-columns:1fr 14px 1fr;justify-items:center;align-items:center;margin-top:6px}.time-controls button{width:100%;padding:2px;border:0;background:transparent;font-size:18px;line-height:1;cursor:pointer}.time-value{font-size:20px;font-weight:600;padding:5px 0}.time-separator{font-size:18px}.hidden{display:none}</style>`; }
}
