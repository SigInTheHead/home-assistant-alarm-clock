...
CONF_PRIMARY_PRE_REPEAT = "primary_pre_repeat"
...
CONF_FOLLOWUP_PRE_REPEAT = "followup_pre_repeat"
...
DEFAULT_OPTIONS = {
    ...
    CONF_DAY_TIMES: {day: "07:00:00" for day in DAYS},
    CONF_DAY_ENABLED: {day: True for day in DAYS},
    CONF_PRIMARY_PRE_ENABLED: False, CONF_PRIMARY_PRE_MEDIA: None, CONF_PRIMARY_PRE_VOLUME: 30,
    CONF_PRIMARY_PRE_DURATION: 30, CONF_PRIMARY_PRE_REPEAT: 5,
    ...
    CONF_FOLLOWUP_PRE_DURATION: 30, CONF_FOLLOWUP_PRE_REPEAT: 5,
